...
?>
			<div class="flex flex-col gap-4 sm:flex-row sm:gap-6 majors-alert">
				<div aria-hidden="true" class="<?= $level ?> [&amp;.info]:mask-alert-info [&amp;.success]:mask-alert-success [&amp;.warning]:mask-alert-warning [&amp;.danger]:mask-alert-danger !mask-contain bg-theme-heading-color shrink-0 size-11 sm:size-16 majors-alert__icon"></div>
