 ...
 * Loaded into a popover; posts to save_program. Variables: $program, $cms_url, $degree_maps, $maps_url
...
<form class="ma-settings" data-ma-settings-form>
	...
	<div class="ma-grid-2">
		...
		<div class="ma-field"><label for="ms_catalog">Catalog page</label><input type="url" id="ms_catalog" name="catalog_url" value="<?= $t->e($v('catalog_url')) ?>" maxlength="255" placeholder="https://catalog.wichita.edu/…"></div>
	</div>
