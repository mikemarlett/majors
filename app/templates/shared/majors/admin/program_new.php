...
<section class="<?= $t->cls('section') ?>">
	<form id="newProgramForm" class="ma-user-form ma-new-program" method="post" data-ma-new-program>
		...
		<div class="ma-grid-2">
			...
			<label class="ma-field ma-field--check ma-field--span"><input type="hidden" name="graduate" value="0"><input type="checkbox" name="graduate" value="1" data-ma-graduate> <span>Graduate program (listed under Graduate Degrees; set from the credential, change if needed)</span></label>
